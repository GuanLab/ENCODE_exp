...
$path1="/state2/hyangl/TF_model/data/train_test/mmm_diff/"; # PARAMETER: change the directory names F,G,H,I
...
@cell_feature=("/state4/gyuanfan/TF_model/data/anchor_bam_DNAse/", # PARAMETER
        "/state4/gyuanfan/TF_model/data/anchor_bam_DNAse_diff/",
        "/state4/gyuanfan/TF_model/data/anchor_bam_DNAse_max_min/",
        "/state4/gyuanfan/TF_model/data/anchor_bam_DNAse_max_min_diff/");
