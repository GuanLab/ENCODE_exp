...
$path1="/state2/hyangl/TF_model/data/train_test/mmm_diff_largespace/"; # PARAMETER: change the directory names F,G,H,I
$path2="/state2/hyangl/TF_model/data/sample/01/"; # PARAMETER: F-01,G-02,H-03,I-04

$tf_list="/state2/hyangl/TF_model/data/index/tf_list.txt"; # PARAMETER
...
open INDEX_SET1, "/state2/hyangl/TF_model/data/index/ind_chr_set1.txt" or die;
