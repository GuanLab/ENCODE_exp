...
$path1="/state2/hyangl/TF_model/data/train_test/macs/G/"; # PARAMETER: change the directory names F,G,H,I
$path2="/state2/hyangl/TF_model/model/macs/G/"; # PARAMETER: F,G,H,I
