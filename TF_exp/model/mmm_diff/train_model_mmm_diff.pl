...
$path1="/state3/hyangl/TF_model/data/train_test/mmm_diff/"; # PARAMETER: change the directory names F,G,H,I
$path2="/state3/hyangl/TF_model/model/mmm_diff/"; # PARAMETER: F,G,H,I
