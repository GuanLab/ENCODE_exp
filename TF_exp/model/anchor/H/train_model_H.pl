...
$path1="/state2/hyangl/TF_model/data/train_test/anchor/H/"; # PARAMETER: change the directory names F,G,H,I
$path2="/state2/hyangl/TF_model/model/anchor/H/"; # PARAMETER: F,G,H,I
