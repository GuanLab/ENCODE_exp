...
$path1="/state2/hyangl/TF_model/data/train_test/anchor/I/"; # PARAMETER: change the directory names F,G,H,I
$path2="/state2/hyangl/TF_model/model/anchor/I/"; # PARAMETER: F,G,H,I
