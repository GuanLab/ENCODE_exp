...
$path1="/state2/hyangl/TF_model/data/train_test/anchor/F/"; # PARAMETER: change the directory names F,G,H,I
$path2="/state2/hyangl/TF_model/model/anchor/F/"; # PARAMETER: F,G,H,I
