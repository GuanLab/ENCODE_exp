...
@model_dir1=glob "/state3/hyangl/TF_model/model/macs/H/*set1_eva"; # PARAMETER: F/G/H/I
@model_dir2=glob "/state3/hyangl/TF_model/model/macs/H/*set2_eva"; # PARAMETER
$path="/state3/hyangl/TF_model/prediction/macs/H/separated/"; # PARAMETER
