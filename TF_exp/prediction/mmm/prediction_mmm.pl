...
@model_dir1=glob "/state2/hyangl/TF_model/model/mmm/*set1_eva"; # PARAMETER: F/G/H/I
@model_dir2=glob "/state2/hyangl/TF_model/model/mmm/*set2_eva"; # PARAMETER
$path="/state2/hyangl/TF_model/prediction/mmm/separated/"; # PARAMETER
