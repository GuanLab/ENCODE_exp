...
@model_dir1=glob "/state2/hyangl/TF_model/model/tf/*set1_eva"; # PARAMETER: F/G/H/I
@model_dir2=glob "/state2/hyangl/TF_model/model/tf/*set2_eva"; # PARAMETER
$path="/state2/hyangl/TF_model/prediction/tf/separated/"; # PARAMETER

$list_to_predict="/state2/hyangl/TF_model/data/index/final_list.txt"; # PARAMETER

#@cell_feature=("/state2/hyangl/TF_model/data/feature/DNAse_largespace/", # PARAMETER
#    "/state2/hyangl/TF_model/data/feature/DNAse_diff_largespace/",
#    "/state2/hyangl/TF_model/data/feature/DNAse_max_min_largespace/",
#    "/state2/hyangl/TF_model/data/feature/DNAse_max_min_diff_largespace/",
#    "/state2/hyangl/TF_model/data/feature/orange_rank_largespace/");
