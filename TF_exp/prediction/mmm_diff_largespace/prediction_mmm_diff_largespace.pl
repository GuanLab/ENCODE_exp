...
@model_dir1=glob "/state2/hyangl/TF_model/model/mmm_diff_largespace/*set1_eva"; # PARAMETER: F/G/H/I
@model_dir2=glob "/state2/hyangl/TF_model/model/mmm_diff_largespace/*set2_eva"; # PARAMETER
$path="/state2/hyangl/TF_model/prediction/mmm_diff_largespace/separated/"; # PARAMETER

$list_to_predict="/state2/hyangl/TF_model/data/index/final_list.txt"; # PARAMETER

@cell_feature=("/state4/gyuanfan/TF_model/data/anchor_bam_DNAse_largespace/", # PARAMETER
        "/state4/gyuanfan/TF_model/data/anchor_bam_DNAse_diff_largespace/",
        "/state4/gyuanfan/TF_model/data/anchor_bam_DNAse_max_min_largespace/",
        "/state4/gyuanfan/TF_model/data/anchor_bam_DNAse_max_min_diff_largespace/");
...
#        $name='INPUT'.$num;
#        open $name, "$the_feature/$the_tf" or die; # PARAMETER: FG $the_feature/$the_tf HI $the_feature
#        $num++;
#    }
