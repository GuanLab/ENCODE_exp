...
@model_dir1=glob "/state3/hyangl/TF_model/model/anchor/I/*set1_eva"; # PARAMETER: F/G/H/I
@model_dir2=glob "/state3/hyangl/TF_model/model/anchor/I/*set2_eva"; # PARAMETER
$path="/state3/hyangl/TF_model/prediction/anchor/I/separated/"; # PARAMETER
