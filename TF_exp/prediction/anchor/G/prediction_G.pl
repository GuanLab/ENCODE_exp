...
@model_dir1=glob "/state3/hyangl/TF_model/model/anchor/G/*set1_eva"; # PARAMETER: F/G/H/I
@model_dir2=glob "/state3/hyangl/TF_model/model/anchor/G/*set2_eva"; # PARAMETER
$path="/state3/hyangl/TF_model/prediction/anchor/G/separated/"; # PARAMETER

$list_to_predict="/state3/hyangl/TF_model/data/index/test_list.txt"; # PARAMETER

@cell_feature=("/state3/hyangl/TF_model/data/feature/anchor_bam_DNAse_largespace/", # PARAMETER
    "/state3/hyangl/TF_model/data/feature/anchor_bam_DNAse_diff_largespace/",
    "/state3/hyangl/TF_model/data/feature/anchor_bam_DNAse_max_min_largespace/",
    "/state3/hyangl/TF_model/data/feature/anchor_bam_DNAse_max_min_diff_largespace/",
