...
@model_dir1=glob "/state3/hyangl/TF_model/model/tf_all/*set1_eva"; # PARAMETER: F/G/H/I
@model_dir2=glob "/state3/hyangl/TF_model/model/tf_all/*set2_eva"; # PARAMETER
$path="/state3/hyangl/TF_model/prediction/tf_all/separated/"; # PARAMETER
