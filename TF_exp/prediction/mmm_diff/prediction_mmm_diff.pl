...
@model_dir1=glob "/state3/hyangl/TF_model/model/mmm_diff/*set1_eva"; # PARAMETER: F/G/H/I
@model_dir2=glob "/state3/hyangl/TF_model/model/mmm_diff/*set2_eva"; # PARAMETER
$path="/state3/hyangl/TF_model/prediction/mmm_diff/separated/"; # PARAMETER

$list_to_predict="/state3/hyangl/TF_model/data/index/final_list.txt"; # PARAMETER

@cell_feature=("/state3/hyangl/TF_model/data/feature/anchor_bam_DNAse/", # PARAMETER
        "/state3/hyangl/TF_model/data/feature/anchor_bam_DNAse_diff/",
        "/state3/hyangl/TF_model/data/feature/anchor_bam_DNAse_max_min/",
        "/state3/hyangl/TF_model/data/feature/anchor_bam_DNAse_max_min_diff/");
