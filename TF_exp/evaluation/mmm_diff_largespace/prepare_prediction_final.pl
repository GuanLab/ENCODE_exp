...
$path1="/state2/hyangl/TF_model/prediction/mmm_diff_largespace/combined/"; # PARAMETER F_G_H_I, F_G, H_I
$path2="/state2/hyangl/TF_model/evaluation/mmm_diff_largespace/"; # PARAMETER

@all_chr=('chr10','chr11','chr12','chr13','chr14','chr15','chr16','chr17','chr18','chr19',
    'chr2','chr20','chr22','chr3','chr4','chr5','chr6','chr7','chr9','chrX');

open INDEX_SET1, "/home/hyangl/TF_model/data/index/ind_chr_set1.txt" or die;
%chr_set1=();
...
#@all_target=glob "/home/gyuanfan/2017/TF/data/raw/ChIPseq/labels/*tsv";
@all_target=glob "/home/hyangl/TF_model/data/heldout/heldout_celltype/labels/*tsv";
foreach $target (@all_target){ # all 32 tf files; but we only predict 13 tf
    ...
    foreach $cell (@all_cell) {
        ...
        if (-f "${path1}${tf}.${cell}_set1_model") {
            ...
            open INDEX, "/home/gyuanfan/2017/TF/data/raw/annotations/test_regions.blacklistfiltered.bed" or die;
            while ($val1=<PRED1>){
                chomp $val1;
                $val2=<PRED2>;
                chomp $val2;
                ...
                $val1=int($val1*10000000)/10000000; # save some space
                $val2=int($val2*10000000)/10000000;
